<%@ Page Language="C#" Title="系角色详情" Inherits="BasePageView<RoleDetailViewData>" %>
...
<head>
    ...
    <meta charset="utf-8">
    <title>角色详情</title>
    <meta name="description" content="角色详情">
    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                <form class="form-horizontal" id="formRole" role="form" method="<%= this.Model.Method %>"
                action="<%= this.Model.Url %>" enctype="multipart/form-data">
                <input type="hidden" name="RoleGuid" value="<%= this.Model.Entity.RoleGuid %>" />
                <div id="paymentInfo">
...
<%= BaseFrameWork.Tool.WebHelper.GetJSLink("/System/RoleDetail.js")%>
