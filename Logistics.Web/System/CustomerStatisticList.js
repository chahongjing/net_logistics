window.Utility.registerNameSpace('window.System.CustomerStatisticList');
...
(function(ns) {
    ...
    ns.search = function() {
        ...
        $("#formSearch").find('input[name=orderBy]').val("CreatedOn DESC, Name");
    ...
    ns.export = function () {
        ...
        form.attr("action", "/System/CustomerStatisticListExport.aspx");
...
})(window.System.CustomerStatisticList);

$(function() {
    window.System.CustomerStatisticList.initial();
});