...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <form class="form-search" id="formSearch" method="post" action="/AjaxCustomer/StatisticSearch.cspx">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="widget-main">
                    <div class="col-xs-1 col-sm-1 no-padding-left no-padding-right">
                        <div class="input-group text-center" style="padding-top: 10px;">是否完成</div>
                    </div>
                    <div class="col-xs-5 col-sm-5">
                        <div class="radio col-sm-6 no-padding-left no-padding-right">
                            <label>
                                <input name="form-field-radio1" type="radio" checked class="ace" onclick="$('input[name=num]').val('0')">
                                <span class="lbl">是 </span>
                            </label>
                        </div>
                        <div class="radio col-sm-6 no-padding-left no-padding-right" style="margin-top:9px;">
                            <label>
                                <input name="form-field-radio1" type="radio" class="ace" onclick="$('input[name=num]').val('1')">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="modal-content">
                ...
                <div id="divTbl">
                    <%= BaseFrameWork.MVC.UserControlExcutor.RenderUserControl("/System/UserControl/CustomerStatisticList.ascx", this.Model)%>
                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Bottom" runat="server">
    ...
    <%= BaseFrameWork.Tool.WebHelper.GetJSLink("/System/CustomerStatisticList.js")%>
