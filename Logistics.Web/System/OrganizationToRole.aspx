<%@ Page Language="C#" AutoEventWireup="true" Inherits="BasePageView<BusinessToRoleViewData>" %>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="modal-content">
                            <div class="modal-header no-padding" id="Div3">
                                ...
                                <input type="hidden" name="BusinessGuid" value="<%= this.Model.BusinessGuid %>" />
...
<%= BaseFrameWork.Tool.WebHelper.GetJSLink("/System/OrganizationToRole.js")%>
