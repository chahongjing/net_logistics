window.Utility.registerNameSpace('window.System.SelectAgentCompany');
...
(function (ns) {
    ...
    ns.search = function () {
        ...
        // 删除记录
        Utility.processAjax({
            url: "/AjaxAgentCompany/SelectSearch.cspx",
...
})(window.System.SelectAgentCompany);

$(function () {
    window.System.SelectAgentCompany.initial();
});