<%@ Page Language="C#" AutoEventWireup="true" Inherits="BasePageView<ActionDetailViewData>" %>
...
<head>
    ...
    <meta charset="utf-8">
    <title>功能点详情</title>
    <meta name="description" content="功能点详情">
    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                <form class="form-horizontal" id="formAction" role="form" method="<%= this.Model.Method %>"
                action="<%= this.Model.Url %>" enctype="multipart/form-data">
                <input type="hidden" name="ActionGuid" value="<%= this.Model.Entity.ActionGuid %>" />
                <div id="paymentInfo">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-10 miniGroup">
                            <div class="input-group">
                                <input type="text" name="SystemName" placeholder="系统" readonly class="form-control"
                                    value="<%= this.Model.Entity.SystemName %>">
                                <span class="input-group-addon selectPeople" id="btnGetSystem"><i class="fa fa-search bigger-110">
                                </i></span>
                    ...
                    <div class="form-group">
                        <label class="col-md-2 col-sm-2 col-xs-2 control-label no-padding-right" class="form-control">
                            <font color="red">*</font>模块
                        </label>
                        <div class="col-md-10 col-sm-10 col-xs-10 miniGroup">
                            <div class="input-group">
                                <input type="text" name="FunctionName" placeholder="模块" readonly class="form-control"
                                    value="<%= this.Model.Entity.FunctionName %>">
                                <span class="input-group-addon selectPeople" id="btnGetFunction"><i class="fa fa-search bigger-110">
                                </i></span>
                                <input type="hidden" name="FunctionGuid" value="<%= this.Model.Entity.FunctionGuid %>" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
...
<%= BaseFrameWork.Tool.WebHelper.GetJSLink("/System/ActionDetail.js")%>
