<%@ Page Language="C#" AutoEventWireup="true" Inherits="BasePageView<PriceListViewData>" %>
...
<body class="no-skin">
            ...
            <div class="widget-main">
	            <form class="form-search">
                    <div class="col-xs-2 col-sm-2 no-padding-left no-padding-right">
                        <div class="input-group text-center" style="padding-top:10px;font-size:13px;">按地点查询</div>
                    </div>
			        <div class="col-xs-10 col-sm-10">
				        <div class="input-group">
					        <input type="text" class="form-control search-query" name="key" placeholder="输入起运地或目的地或中转地查询" />
                            <input type="hidden" name="Amount" value="<%= this.Model.Amount %>" />
                            <input type="hidden" name="Type" value="<%= this.Model.Type %>" />
    ...
    <div id="divTbl">
        <%= BaseFrameWork.MVC.UserControlExcutor.RenderUserControl("/System/UserControl/SelectPrice.ascx", this.Model)%>
    </div>
...
<%= BaseFrameWork.Tool.WebHelper.GetJSLink("/System/SelectPrice.js")%>
