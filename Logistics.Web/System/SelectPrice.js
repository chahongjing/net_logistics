window.Utility.registerNameSpace('window.System.SelectPrice');
...
(function (ns) {
    ...
    ns.search = function () {
        ...
        // 删除记录
        Utility.processAjax({
            url: "/AjaxPrice/SelectSearch.cspx",
            postData: { SearchKey: $('input[name=key]').val(), Amount : $('input[name=Amount]').val(), Type : $('input[name=Type]').val(), pageIndex: pageIndex, pageSize: pageSize, orderBy: "StartPlace, DestinationPlace, InterimPlace, Type, LuggageAmount" },
            async: false,
            callBack: function (data) {
...
})(window.System.SelectPrice);

$(function () {
    window.System.SelectPrice.initial();
});