<%@ Page Language="C#" MasterPageFile="~/System/Main.Master" Inherits="BasePageView<NavigationListViewData>"
    Title="后台导航管理" %>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="modal-content">
                ...
                <div id="divTblFirst">
                    <%= BaseFrameWork.MVC.UserControlExcutor.RenderUserControl("/System/UserControl/NavigationListFirst.ascx", this.Model)%>
                </div>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="modal-content">
                ...
                <div id="divTblSecond">
                    <%= BaseFrameWork.MVC.UserControlExcutor.RenderUserControl("/System/UserControl/NavigationListSecond.ascx", this.Model)%>
                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Bottom" runat="server">
    ...
    <%= BaseFrameWork.Tool.WebHelper.GetJSLink("/System/NavigationList.js")%>
