<%@ Page Language="C#" MasterPageFile="~/System/Main.Master" Inherits="BasePageView<FunctionListViewData>" Title="无标题页" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
<%= BaseFrameWork.Tool.WebHelper.GetCSSLink("/Front/Controls/DialogBox.css")%>
    <style>
        #tblFunctionList tr.selected
        {
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="modal-content">
                ...
                <div id="divTbl">
                    <%= BaseFrameWork.MVC.UserControlExcutor.RenderUserControl("/System/UserControl/FunctionList.ascx", this.Model)%>
                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Bottom" runat="server">
    ...
    <%= BaseFrameWork.Tool.WebHelper.GetJSLink("/System/FunctionList.js")%>
