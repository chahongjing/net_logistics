<%@ Page Language="C#" AutoEventWireup="true" Inherits="BasePageView<RolePermissionListViewData>" %>
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="modal-content">
                            <div class="modal-header no-padding" id="Div3">
                                ...
                                <input type="hidden" name="RoleGuid" value="<%= this.Model.RoleGuid %>" />
                            ...
                            <div id="divTable">
                                <%= BaseFrameWork.MVC.UserControlExcutor.RenderUserControl("/System/UserControl/RolePermissionList.ascx", this.Model.List)%>
                            </div>
...
<%= BaseFrameWork.Tool.WebHelper.GetJSLink("/System/RoleToPermissionList.js")%>
