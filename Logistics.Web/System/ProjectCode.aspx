					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="/Front/dist/avatars/user.jpg" alt="Jason's Photo" />
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<script type="text/javascript">
								    var $/Front/dist = "/Front/dist"; //this will be used in fuelux.tree-sampledata.js
								</script>
...
<![endif]-->
		...
		<script type="text/javascript">
		    window.jQuery || document.write("<script src='/Front/dist/js/jquery-2.0.3.min.js'>" + "<" + "/script>");
		</script>
		...
		<!--[if IE]>
<script type="text/javascript">
 window.jQuery || document.write("<script src='/Front/dist/js/jquery-1.10.2.min.js'>"+"<"+"/script>");
</script>
<![endif]-->

		<script type="text/javascript">
		    if ("ontouchend" in document) document.write("<script src='/Front/dist/js/jquery.mobile.custom.min.js'>" + "<" + "/script>");
		</script>
		<script src="/Front/dist/js/bootstrap.min.js"></script>
		<script src="/Front/dist/js/typeahead-bs2.min.js"></script>

		<!-- page specific plugin scripts -->

		<script src="/Front/dist/js/fuelux/data/fuelux.tree-sampledata.js"></script>
