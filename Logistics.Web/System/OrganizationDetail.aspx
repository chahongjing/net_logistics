<%@ Page Language="C#" Title="组织架构详情" Inherits="BasePageView<OrganizationDetailViewData>" %>
...
<head>
    ...
    <meta charset="utf-8">
    <title>组织架构详情</title>
    <meta name="description" content="组织架构详情">
    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                <form class="form-horizontal" id="formOrganization" role="form" method="<%= this.Model.Method %>"
                action="<%= this.Model.Url %>" enctype="multipart/form-data">
                <input type="hidden" name="UnitGuid" value="<%= this.Model.Entity.UnitGuid %>" />
                <div id="paymentInfo">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-10 miniGroup">
                            <div class="input-group">
                                <input type="text" name="ParentName" placeholder="上级" readonly class="form-control"
                                    value="<%= this.Model.Entity.ParentName %>">
                                <span class="input-group-addon selectPeople" id="Span1" disabled><i class="fa fa-search bigger-110">
                                </i></span>
                                <input type="hidden" name="ParentGuid" value="<%= this.Model.Entity.ParentGuid %>" />
                                <input type="hidden" name="ParentCode" value="<%= this.Model.Entity.ParentCode %>" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
...
<%= BaseFrameWork.Tool.WebHelper.GetJSLink("/System/OrganizationDetail.js")%>
