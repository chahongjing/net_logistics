<%@ Page Language="C#" AutoEventWireup="true" Inherits="BasePageView<FunctionDetailViewData>" %>
...
<head>
    ...
    <meta charset="utf-8">
    <title>模块详情</title>
    <meta name="description" content="模块详情">
    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                <form class="form-horizontal" id="formFunction" role="form" method="<%= this.Model.Method %>"
...
<%= BaseFrameWork.Tool.WebHelper.GetJSLink("/System/FunctionDetail.js")%>
