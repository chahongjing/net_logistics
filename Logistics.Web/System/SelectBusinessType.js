window.Utility.registerNameSpace('window.System.SelectBusinessType');
...
(function (ns) {
    ...
    ns.search = function () {
        ...
        // 删除记录
        Utility.processAjax({
            url: "/AjaxBusinessType/SelectSearch.cspx",
...
})(window.System.SelectBusinessType);

$(function () {
    window.System.SelectBusinessType.initial();
});