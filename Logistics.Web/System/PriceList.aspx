<%@ Page Language="C#" MasterPageFile="/System/Main.Master" Inherits="BasePageView<PriceListViewData>"
    Title="用户列表" %>
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="modal-content">
                ...
                <div id="divTbl">
                    <%= BaseFrameWork.MVC.UserControlExcutor.RenderUserControl("/System/UserControl/PriceList.ascx", this.Model)%>
                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Bottom" runat="server">
    ...
    <%= BaseFrameWork.Tool.WebHelper.GetJSLink("/System/PriceList.js")%>
