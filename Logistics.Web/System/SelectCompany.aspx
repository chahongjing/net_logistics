<%@ Page Language="C#" AutoEventWireup="true" Inherits="BasePageView<CompanyListViewData>" %>
...
<body class="no-skin">
    ...
    <div id="divTbl">
        <%= BaseFrameWork.MVC.UserControlExcutor.RenderUserControl("/System/UserControl/SelectCompanyList.ascx", this.Model)%>
    </div>
...
<%= BaseFrameWork.Tool.WebHelper.GetJSLink("/System/SelectCompany.js")%>
