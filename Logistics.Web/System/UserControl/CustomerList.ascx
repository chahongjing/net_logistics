    ...
    <tbody>
        ...
        <tr class="<%= i == 0 ? "selected" : string.Empty %>" data-oid="<%= entity.CustomerID %>">
            ...
            <td class="text-center icon w50">
                <i class="ace-icon fa fa-pencil green bigger-110" title="编辑" onclick="window.System.CustomerList.edit(this)">
                </i><i class="ace-icon fa fa-trash-o bigger-110 orange" title="删除" onclick="window.System.CustomerList.deleteRecord(this)">
