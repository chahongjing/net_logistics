...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
    ...
    <form class="form-search" id="formSearch" method="post" action="/AjaxCustomer/MonthSearch.cspx">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="modal-content">
                ...
                <div id="divTbl">
                    <%= BaseFrameWork.MVC.UserControlExcutor.RenderUserControl("/System/UserControl/CustomerMonthList.ascx", this.Model)%>
                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Bottom" runat="server">
    ...
    <%= BaseFrameWork.Tool.WebHelper.GetJSLink("/System/CustomerMonthList.js")%>
