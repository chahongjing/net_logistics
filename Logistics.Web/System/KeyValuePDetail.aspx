<%@ Page Language="C#" AutoEventWireup="true" Inherits="BasePageView<KeyValuePDetailViewData>" %>
...
<head>
    ...
    <meta charset="utf-8">
    <title>业务参数</title>
    <meta name="description" content="业务参数">
    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="page-content">
                <form class="form-horizontal" id="formKeyValueP" role="form" method="<%= this.Model.Method %>"
                action="<%= this.Model.Url %>" enctype="multipart/form-data">
                <input type="hidden" name="ID" value="<%= this.Model.Entity.ID %>" />
                <input type="hidden" name="Group" value="<%= this.Model.Entity.Group %>" />
                <div id="paymentInfo">
                    ...
                    <div class="form-group">
                        <label class="col-md-2 col-sm-2 col-xs-2 control-label no-padding-right" class="form-control">
                            <font color="red">*</font>父级
                        </label>
                        <div class="col-md-10 col-sm-10 col-xs-10 miniGroup">
                            <div class="input-group">
                                <input type="text" name="ParentName" placeholder="父级" readonly class="form-control"
                                    value="<%= this.Model.Entity.ParentName %>">
                                <span class="input-group-addon selectPeople" id="btnGetParent"><i class="fa fa-search bigger-110">
                                </i></span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-10 miniGroup">
                            <span>
                                <input type="text" name="Remark" placeholder="备注" class="form-control" value="<%= this.Model.Entity.Remark %>">
                            </span>
                        </div>
                    </div>
                </div>
...
<%= BaseFrameWork.Tool.WebHelper.GetJSLink("/System/KeyValuePDetail.js")%>
