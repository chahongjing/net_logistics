<%@ Page Language="C#" AutoEventWireup="true" Inherits="BasePageView<AgentCompanyListViewData>" %>
...
<body class="no-skin">
    ...
    <div id="divTbl">
        <%= BaseFrameWork.MVC.UserControlExcutor.RenderUserControl("/System/UserControl/SelectAgentCompany.ascx", this.Model)%>
    </div>
...
<%= BaseFrameWork.Tool.WebHelper.GetJSLink("/System/SelectAgentCompany.js")%>
