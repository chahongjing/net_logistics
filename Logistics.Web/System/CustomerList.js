window.Utility.registerNameSpace('window.System.CustomerList');
...
(function(ns) {
    ns.initial = function() {
        ...
        $('#btnExport').click(ns.exportToExcel);
    ...
    ns.exportToExcel = function () {
        ...
        form.attr("action", "/System/CustomerListExport.aspx");
...
})(window.System.CustomerList);

$(function() {
    window.System.CustomerList.initial();
});