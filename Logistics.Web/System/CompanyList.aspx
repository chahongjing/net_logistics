<%@ Page Language="C#" MasterPageFile="~/System/Main.Master" Inherits="BasePageView<CompanyListViewData>"
    Title="无标题页" %>

<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    <%= BaseFrameWork.Tool.WebHelper.GetCSSLink("/Front/Controls/DialogBox.css")%>
    <style>
        #tblCompanyList tr.selected
        {
	            ...
	            <form class="form-search">
			        ...
			        <div class="col-xs-10 col-sm-10">
				        <div class="input-group">
					        <input type="text" class="form-control search-query" name="key" placeholder="输入公司名称查询" />
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="modal-content">
                ...
                <div id="divTbl">
                    <%= BaseFrameWork.MVC.UserControlExcutor.RenderUserControl("/System/UserControl/CompanyList.ascx", this.Model)%>
                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="Bottom" runat="server">
    ...
    <%= BaseFrameWork.Tool.WebHelper.GetJSLink("/System/CompanyList.js")%>
