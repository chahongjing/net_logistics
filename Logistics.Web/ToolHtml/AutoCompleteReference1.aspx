...
<asp:Content ID="Content3" ContentPlaceHolderID="Bottom" runat="server">
    <script type="text/javascript">
        ...
        function convertToJSReference() {
            ...
            arrResult.push(strSpace + "    optionData.url = \"/XMLHTTP.cspx\";");
            arrResult.push(strSpace + "    optionData.getData.oid = appForm.oid.value;");
            arrResult.push(strSpace + "    ");
            arrResult.push(strSpace + "    optionData.getData.oid = \"xxxx\";");
            arrResult.push(strSpace + "    jReturn = processAjax(optionData);");
            arrResult.push(strSpace + "    if (jReturn.Status != \"OK\") {");
            arrResult.push(strSpace + "        if (jReturn.Message) {");
            arrResult.push(strSpace + "            alert(jReturn.Message);");
            arrResult.push(strSpace + "        }");
            arrResult.push(strSpace + "        return false;");
            arrResult.push(strSpace + "    }");
            arrResult.push(strSpace + "    //处理成功, 刷新页面");
            arrResult.push(strSpace + "}");
        ...
        function convertToVBReference() {
            ...
            arrResult.push("    Dim i As Int32");
            arrResult.push("");
            arrResult.push("    sql = \"\" & _");
            arrResult.push("    \"\"");
            arrResult.push("");
            arrResult.push("    Try");
            arrResult.push("        i = MyDB.ExecuteSql(sql)");
            arrResult.push("    Catch ex As Exception");
            arrResult.push("        i = -1");
            arrResult.push("    End Try");
            arrResult.push("");
            arrResult.push("    If (i > 0) Then");
            arrResult.push("        ret = New Result(\"OK\")");
            arrResult.push("    ElseIf (i = 0) Then");
        ...
        function convertToCSReference() {
            ...
            arrResult.push("/// 创 建 人： " + strCreateBy);
            arrResult.push("/// 创建日期： " + (new Date()).format("yyyy-MM-dd HH:mm:ss"));
            arrResult.push("public string " + $("#txtFunctionName").val() + "()");
            arrResult.push("{");
            arrResult.push("    string sql;");
            arrResult.push("    AjaxResult ret;");
            arrResult.push("    int i;");
            arrResult.push("");
            arrResult.push("    sql = \"\";");
            arrResult.push("    using (DbConnectionScope scs = new DbConnectionScope(ConfigHelper.DefaultConnectionString))");
            arrResult.push("    {");
            arrResult.push("        var p = new { UserName = HttpContext.Current.Request[\"txtUserName\"].ToString() };");
            arrResult.push("        i = DbHelper.Db(sql, p).ExecuteNonQuery();");
            arrResult.push("    }");
            arrResult.push("    if (i > 0)");
            arrResult.push("    {");
            arrResult.push("        ret = new AjaxResult(\"OK\");");
            arrResult.push("    }");
            arrResult.push("    else if (i == 0)");
            arrResult.push("    {");
            arrResult.push("        ret = new AjaxResult(\"NO\", \"未找到数据！\");");
            arrResult.push("        ret.Add(\"oid\");");
            arrResult.push("    }");
            arrResult.push("    else");
            arrResult.push("    {");
            arrResult.push("        ret = new AjaxResult(\"OK\", \"数据库错误！\");");
            arrResult.push("        ret.Add(\"oid\");");
            arrResult.push("    }");
            arrResult.push("    return ret.ToString();");
            arrResult.push("}");
